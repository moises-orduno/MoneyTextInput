package com.moises.moneytextinput.moneyMaskUs;
 ...
 */
public class MoneyMaskWholeNoCentsNumbers implements TextWatcher {

    private String currencySymbol = "$";
    private EditText editText;
    public MoneyMaskWholeNoCentsNumbers(EditText editText) {
    ...
    private String formateToMoney(float balance){
        ...
        return formattedBalance.substring(0, formattedBalance.indexOf("."));
    }
    ...
    public void afterTextChanged(Editable editable) {
        ...
        String fromEditText= editable.toString();
        String s=fromEditText.substring(0,fromEditText.length()-1)+".00"+fromEditText.charAt(fromEditText.length()-1);
